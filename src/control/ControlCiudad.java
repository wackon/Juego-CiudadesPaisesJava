...
public class ControlCiudad {
    ...
    Ciudades objCiudades;

    public ControlCiudad(Ciudades objCiudades) {
        this.objCiudades = objCiudades;
    }

    public void guardar() {
        String cod = objCiudades.getCodigo();
        String nom = objCiudades.getNombre();
        String codP = objCiudades.getCodigoPais();
        ...
        if (sw == false) {
            String cadCiudad = cod + "," + nom + "," + codP;
            objArchivos.escribirUnaLineaYDebajo(cadCiudad);
    ...
    public void modificar() {
        ...
        while (i <= nLineas) {
            ...
            if (!arrLinea[0].equals(objCiudades.getCodigo())) {
        ...
        objArchivos2.renombrarUnArchivo("ciudades.tmp", "paises.txt");
    ...
    public void borrar() {
        ...
        objArchivos.renombrarUnArchivo("ciudades.tmp", "paises.txt");
